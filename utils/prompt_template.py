...
def read_task_prompt(prompt_type):
    with open('./utils/task_prompt_'+prompt_type+'.json', 'r', encoding='utf-8') as prompt_file:
        task_prompt = json.load(prompt_file)
    return task_prompt

with open('./utils/task_prompt_fewshot.json', 'r', encoding='utf-8') as file:
    task_prompt = json.load(file)

with open('./utils/task_prompt_zeroshot.json', 'r', encoding='utf-8') as file:
